    ...
    public class DetailsModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(long? id)
        {
            ...
            Ticket = await _context.Tickets
                ...
                .Include(t => t.TicketRequirements)
                .Include(t => t.TicketStaff)
        ...
        public async Task<IActionResult> OnPostSubmit()
        {
            ...
            string mi = $"Our Staff " + Profile.FullName + " has replied Your ticket # (" + tik.TicketNumber + ") <br><br>" +
                $"================================<br>" +
                $"" + ChatMessage +
                $"<br>================================<br>" +
            ...
            try
            {
                ...
                foreach (var mm in ticketsupervisor)
                {
                    ...
                    if (mm.SendEmail == true)
                    {
                        ...
                        string xm = "Ticket Response <br>================================<br><br> " +

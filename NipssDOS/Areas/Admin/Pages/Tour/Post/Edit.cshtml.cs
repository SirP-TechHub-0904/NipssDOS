...
namespace NipssDOS.Areas.Admin.Pages.Tour.Post
{
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _context.Attach(TourPost).State = EntityState.Modified;
        ...
        private bool TourPostExists(long id)
        {
            return _context.TourPosts.Any(e => e.Id == id);
        }
    }
}

...
namespace NipssDOS.Areas.Admin.Pages.Rapid
{
    public class GenerateRapidModel : PageModel
    {
        ...
        public GenerateRapidModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
           var Profile = await _context.Profiles
            ...
            foreach (var x in xcx.ToList())
            {
                ...
                //https://NipssDOS.com/Participant/Dashboard/StartPreview?id=24

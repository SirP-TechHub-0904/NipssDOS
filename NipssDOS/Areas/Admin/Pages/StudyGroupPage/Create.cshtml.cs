...
namespace NipssDOS.Areas.Admin.Pages.StudyGroupPage
{
    public class CreateModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if(alum == null)
            {
                TempData["aaerror"] = "unable to update. No Active Sec";

                return Page();
            }
            StudyGroup.AlumniId = alum.Id;
            ...
            if (HttpContext.Request.Form.Files != null && HttpContext.Request.Form.Files.Count > 0)
            {
                ...
                foreach (var file in files)
                {
                    ...
                    if (file.Length > 0)
                    {
                        ...
                        var fileDbPathName = $"/StudyGroup/".Trim();
                        ...
                        StudyGroup.Photo = $"{fileDbPathName}{newFileName}";
            ...
            return RedirectToPage("/Main/StudyGroupManage", new { area = "Root", id = StudyGroup.AlumniId });
        }
    }
}

...
namespace NipssDOS.Areas.Admin.Pages.ProfileAccount
{
    ...
    public class MailerModel : PageModel
    {
        ...
        public MailerModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<bool> SendEmail(string recipient, string message, string title)
        {
            try
            {
                ...
                mail.Body = message;
                //set the addresses 
                mail.From = new MailAddress("admin@NipssDOS.com", "SEC44 NIPSS"); //IMPORTANT: This must be same as your smtp authentication address.
                ...
                NetworkCredential Credentials = new NetworkCredential("admin@NipssDOS.com", "yvjholmmateuysye");

...
namespace NipssDOS.Areas.Admin.Pages.ProfileAccount
{
    ...
    public class MailerSenderModel : PageModel
    {
        ...
        public MailerSenderModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;

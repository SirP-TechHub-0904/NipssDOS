...
namespace NipssDOS.Areas.Admin.Pages.ProfileAccount
{
    public class SendAllModel : PageModel
    {
        ...
        public SendAllModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;

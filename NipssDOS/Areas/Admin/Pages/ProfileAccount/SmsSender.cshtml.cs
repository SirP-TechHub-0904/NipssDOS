...
namespace NipssDOS.Areas.Admin.Pages.ProfileAccount
{
    ...
    public class SmsSenderModel : PageModel
    {
        ...
        public SmsSenderModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, SignInManager<IdentityUser> signInManager, UserManager<IdentityUser> userManager)
        {
            _context = context;

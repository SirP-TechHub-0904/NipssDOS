...
namespace NipssDOS.Areas.Participant.Pages.TicketPage
{
    public class DetailsModel : PageModel
    {
        ...
        public DetailsModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnPostSubmit()
        {
            ...
            string mi = $"Ticket Reply # (" + tik.TicketNumber + ") <br><br>" +
                ...
                $"" + ChatMessage +
                $"<br>================================<br>" +
                $"<img src=\"https://NipssDOS.com"+n.Image+"\" style=\"height:200px\"><br>";

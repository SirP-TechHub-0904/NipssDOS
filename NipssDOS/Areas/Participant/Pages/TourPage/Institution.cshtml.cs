...
namespace NipssDOS.Areas.Participant.Pages.TourPage
{
    public class InstitutionModel : PageModel
    {
        ...
        public InstitutionModel(NipssDOS.Data.NIPSSDbContext context, UserManager<IdentityUser> userManager, IHostingEnvironment hostingEnv)
        {
            _context = context;

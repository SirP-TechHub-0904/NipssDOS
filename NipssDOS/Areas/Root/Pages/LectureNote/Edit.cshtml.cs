...
namespace NipssDOS.Areas.Root.Pages.LectureNote
{
    [Authorize]
    public class EditModel : PageModel
    {
        ...
        public EditModel(NipssDOS.Data.NIPSSDbContext context, IHostingEnvironment hostingEnv, ILogger<EditModel> logger)
        {
            _context = context;
